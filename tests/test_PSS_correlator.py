...
class TB(object):
    def __init__(self, dut):
        ...
        print(type(dut.PSS_LOCAL))
        print(type(dut.PSS_LOCAL.value))
        print(dut.PSS_LOCAL._handle.get_signal_val_long())
        print(dut.PSS_LOCAL.value)
        binstr = dut.PSS_LOCAL._handle.get_signal_val_binstr()
        result = cocotb.binary.BinaryValue(n_bits=len(binstr))
        result._set_trusted_binstr(binstr)
        print(result.value)
        print(dut.PSS_LOCAL._handle.get_signal_val_str())
